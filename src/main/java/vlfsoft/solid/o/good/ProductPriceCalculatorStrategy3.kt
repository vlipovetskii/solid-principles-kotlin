...
class ProductPriceCalculatorStrategy3(private val productBaseData : ProductBaseData) : ProductPriceCalculatorStrategyA {

    override fun calculateTaxIncludedPrice() = productBaseData.basePrice * 1.18
